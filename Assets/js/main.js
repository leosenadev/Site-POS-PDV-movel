...
$('document').ready(function () {
	...
	$('.owl-carousel.slide-banner').owlCarousel({
         ...
         if($("#section1").innerWidth() < 600){
               
                  $("#section1").removeClass("is-open").addClass("is-hidden");
                  
               
               /*$("#section-titulo").click(function(){
   
                  $("#section1").addClass("is-open");
		...
		if (ViewPortW() < 1000) {
			...
			$('.owl-carousel.artigo-vantagens').owlCarousel({              
			   margin:40,
			   nav: false,
      ...
      $('.owl-carousel.sistemasintegrados').owlCarousel({              
        margin:40,
        nav: false,
        autoplayTimeout: 4000,
        autoplayHoverPause: false,
